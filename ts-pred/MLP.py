...
def plot_loss(test_result, truth):
    ...
    plt.title('MLP Prediction Result', fontdict={'family' : 'Times New Roman', 'size': 16})
    ...
    plt.savefig('graph/MLP.png', dpi=750, bbox_inches='tight')
    plt.close()
...
model = Sequential()
model.add(Dense(32, input_dim=time_steps, activation='relu'))
